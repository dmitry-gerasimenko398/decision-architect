...
Release `1.0.0-rc3` preserves both contracts at `1.0`. The mathematical engine remains accurately recorded as `0.4.0` in result artifacts, while the current report generator and overall release are `1.0.0-rc3`. First-time setup documentation changes do not rewrite demonstrated numerical values.
