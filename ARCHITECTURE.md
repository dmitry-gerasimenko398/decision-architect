...
- A future reviewed version may add dependency-aware uncertainty through validated correlation matrices, copulas, Bayesian networks, or influence diagrams. None is implemented in `1.0.0-rc3`.
